                            ...
                            <div className="bg-[#0A0F0A] rounded-2xl border border-[#00FF88]/10 overflow-hidden relative group">
                                ...
                                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            <h3 className="text-xs font-bold text-[#00B37A] uppercase tracking-widest mb-3">Profile</h3>
                                            <p className="text-[#EAEAEA]/80 leading-relaxed text-sm">
                                    ...
                                    <div>
                                        ...
                                        {searchResult.certifications && searchResult.certifications.length > 0 ? (
                                            ...
                                            <div className="flex items-center gap-2 text-red-400 italic bg-red-500/5 p-3 rounded-lg border border-red-500/10 text-sm">
                                                <AlertTriangle className="h-4 w-4" />
                                                No public certifications found
                                            </div>
                                        )}

                                        <div className="mt-6 p-4 bg-[#00FF88]/5 border border-[#00FF88]/20 rounded-xl">
