        ...
        <div className="min-h-screen bg-[#0a0f0a] text-white flex flex-col">
            ...
            <header className="border-b border-gray-800 p-6 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="font-bold text-xl tracking-wider">SOVAP<span className="text-gray-500">VERIFY</span></span>
                </div>
                <div className="text-sm text-gray-400">Official Credential Validation</div>
            </header>

            {/* Content */}
            <main className="flex-grow flex flex-col items-center p-8 max-w-4xl mx-auto w-full">
                ...
                <div className="bg-[#111827] border border-gray-800 rounded-2xl p-8 w-full max-w-2xl text-center shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="h-24 w-24 bg-green-500/10 rounded-full flex items-center justify-center border border-green-500/50">
                            <CheckCircle className="h-12 w-12 text-green-500" />
                        </div>
                    </div>

                    <h1 className="text-3xl font-bold mb-2">Verified Student</h1>
                    <p className="text-gray-400 mb-8">The identity of this student has been confirmed by SOVAP.</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8 text-left bg-black/30 p-6 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-green-400">Level {student.level} Agent</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        {student.certificates && student.certificates.length > 0 ? (
                            student.certificates.map((cert: string, index: number) => {
                                ...
                                let courseNameDisplay = "Cyber Security Course";
                                if (parts.length > 2) {
                                ...
                                return (
                                    <a
                                        ...
                                        className="block p-4 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 transition flex justify-between items-center group"
                                    >
                                        <span className="font-medium text-gray-200 group-hover:text-white">{courseNameDisplay}</span>
                                        <span className="text-xs text-green-500 border border-green-500/30 px-2 py-1 rounded bg-green-500/10">Active</span>
                                    </a>
                                )
                            })
                        ) : (
