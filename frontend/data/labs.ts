...
export const nlpLabs: any[] = [
  {
    id: 'nlp-text-basics',
    title: 'Text Basics',
    description: 'Introduction to basic NLP concepts including tokenization, stemming, and lemmatization.',
    difficulty: 'beginner',
    estimatedTime: '30 min',
    completed: false,
    tools: ['Jupyter', 'NLTK', 'Spacy'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/text-basics',
    instructions: '# Text Basics\n\nLearn the fundamental building blocks of Natural Language Processing.',
  },
  {
    id: 'nlp-preprocessing',
    title: 'Text Preprocessing',
    description: 'Learn how to clean and prepare text data for NLP models by removing noise and normalizing text.',
    difficulty: 'beginner',
    estimatedTime: '45 min',
    completed: false,
    tools: ['Python', 'Pandas', 'Regex'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/preprocessing',
    instructions: '# Text Preprocessing\n\nMaster the art of cleaning text data for better model performance.',
  },
  {
    id: 'nlp-vectorization',
    title: 'Vectorization',
    description: 'Convert text into numerical representations using Bag of Words, TF-IDF, and other techniques.',
    difficulty: 'beginner',
    estimatedTime: '45 min',
    completed: false,
    tools: ['Scikit-learn', 'NumPy'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/vectorization',
    instructions: '# Vectorization\n\nTransform text into numbers that machines can understand.',
  },
  {
    id: 'nlp-classification',
    title: 'Text Classification',
    description: 'Build models to automatically categorize text into predefined classes (e.g., spam detection).',
    difficulty: 'intermediate',
    estimatedTime: '60 min',
    completed: false,
    tools: ['Scikit-learn', 'Naive Bayes'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/classification',
    instructions: '# Text Classification\n\nCreate models to automatically sort and label text data.',
  },
  {
    id: 'nlp-topic-modeling',
    title: 'Topic Modeling',
    description: 'Discover abstract topics within a collection of documents using unsupervised learning.',
    difficulty: 'intermediate',
    estimatedTime: '60 min',
    completed: false,
    tools: ['Gensim', 'LDA'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/topic-modeling',
    instructions: '# Topic Modeling\n\nUncover hidden themes and patterns in large text corpora.',
  },
  {
    id: 'nlp-embeddings',
    ...
    instructions: '# Word Embeddings\n\nLearn how to capture semantic meaning and relationships between words.',
  },
  {
    id: 'nlp-sentiment',
    title: 'Sentiment Analysis',
    description: 'Determine the emotional tone behind a body of text (positive, negative, neutral).',
    difficulty: 'intermediate',
    estimatedTime: '45 min',
    completed: false,
    tools: ['NLTK', 'TextBlob'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/sentiment',
    instructions: '# Sentiment Analysis\n\nAnalyze text to determine the writer\'s attitude and emotional state.',
  },
  {
    id: 'nlp-ner',
    title: 'Named Entity Recognition',
    description: 'Locate and classify named entities like people, organizations, and locations in text.',
    difficulty: 'intermediate',
    estimatedTime: '45 min',
    completed: false,
    tools: ['Spacy', 'NLTK'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/ner',
    instructions: '# Named Entity Recognition\n\nExtract and classify key information entities from unstructured text.',
  },
  {
    id: 'nlp-resume-parser',
    title: 'Resume Parser Project',
    description: 'Build a practical application to extract structured information from resumes.',
    difficulty: 'advanced',
    estimatedTime: '90 min',
    completed: false,
    tools: ['Python', 'Spacy', 'Regex'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/resume-parser',
    instructions: '# Resume Parser\n\nBuild a real-world tool to automate information extraction from CVs.',
  },
  {
    id: 'nlp-neural-net',
    title: 'Neural Networks for NLP',
    description: 'Implement deep learning models for complex NLP tasks using TensorFlow or PyTorch.',
    difficulty: 'advanced',
    estimatedTime: '90 min',
    completed: false,
    tools: ['TensorFlow', 'Keras'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/neural-net',
    instructions: '# Neural Networks for NLP\n\nHarness the power of deep learning for advanced language processing tasks.',
  },
  {
    id: 'nlp-text-gen',
    title: 'Text Generation',
    description: 'Create models capable of generating human-like text, including LLM basics.',
    difficulty: 'advanced',
    estimatedTime: '90 min',
    completed: false,
    tools: ['Transformers', 'Hugging Face'],
    liveUrl: 'https://vulnarable-labs.onrender.com/lab/nlp/text-gen',
    instructions: '# Text Generation\n\nExplore the state-of-the-art in generative AI and text creation.',
  },
];

export const labs = [...cyberLabs, ...nlpLabs];